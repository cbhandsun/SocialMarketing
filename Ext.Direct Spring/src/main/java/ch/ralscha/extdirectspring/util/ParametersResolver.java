	...
	public Object[] resolveParameters(HttpServletRequest request, HttpServletResponse response, Locale locale,
		...
		if (!methodParameters.isEmpty()) {
			...
			for (int paramIndex = 0; paramIndex < methodParameters.size(); paramIndex++) {
				...
				//update by hongtao} else if (directStoreModifyRecords != null && methodParameter.getCollectionType() != null) {
				} else if (directStoreModifyRecords != null && (methodParameter.getCollectionType() != null||methodInfo.getCollectionType()!=null)) {
