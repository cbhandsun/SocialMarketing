...
<jsp:useBean id="bcrequest" class="com.socialmarketing.web.modules.barcode.domain.BarcodeRequestBean"  scope="request"/>
...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    ...
    <p style="height:100px">
      <embed src="<%=genbc%>&ext=.svg" pluginspage="http://www.adobe.com/svg/viewer/install/" width="100%" height="100"></embed>
    </p>
    <%
        } else {
    %>
    <p style="heigth:100px">
      <object type="image/svg+xml" data="<%=genbc%>&ext=.svg" name="DynamicBarcode" width="100%" height="100"></object>
    </p>
    <%
        }
