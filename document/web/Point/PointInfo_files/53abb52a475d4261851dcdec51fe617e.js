...
jQuery(function($){
	...
	if($("#back2top").length > 0)
	{
		...
		var body_width = 960;
		var showDistance = 600;
		//body_width = $.browser.msie && $.browser.version == "6.0" ? 950 : 953;
		//$("#back2top").css("left",Math.floor(($(window).width()-body_width)/2) + body_width + 35 + "px");
		$(window).scroll(function(){
			if($.browser.version!="6.0"){
				$(window).scrollTop()<showDistance ? backtop.fadeOut() : backtop.fadeIn();
			}
		});
...
//			if(resize_width > 10)
//				backtop.css("left",resize_width + body_width + 35 + "px");
//		});
	}
...
{
	$.get(SITE_PATH+"services/service.php?m=exchange&a=logout", function(data){
	  window.location.href = 'http://i.vipshop.com/logout.php?src='+encodeURIComponent(window.location.href);
	});
